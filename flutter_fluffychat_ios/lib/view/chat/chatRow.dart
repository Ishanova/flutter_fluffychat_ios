                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                          ...
                          child: Row(
                            children: [
                              Text(toRow.getChatName(user.name), style: new TextStyle(
                                  fontSize: 18,
                      ...
                      Row(children: [
                        Container(
                          child:
                          Text(
                            (isFromMe(user.name, toRow.messageList.first.senderID) ? "Вы: " : (!toRow.isStudy ? "" : (NameView(toRow.messageList.first.senderID) + ": "))),
                            style: TextStyle (
                                color: backgroundColor
                            ),
                          ),
                        ...
                        Flexible(child: Container(
                          child: Text(toRow.messageList.first.messageText,
                        ...
                        Container(
                          ...
                          child: Text(" · ${toRow.messageList.first.time}",
                            style: TextStyle(
                              color: backgroundColor,
                            ),
                          ),
