...
List chats = [
  ...
  Chat("tanya pyshka",
      {
        User("Иван Петров", "image", OnlineStatus(true, "14 мая 2021", "00:09"), {"Все мы"}, {Folder("Все", {"1111", "2222", "3333", "4444", "5555"}, 1), Folder("Непрочитанные", {"1111", "3333"}, 2), Folder("Учёба", {"5555"}, 3), Folder("Мяу", {"3333"}, 4)}),
        User("Polya Franc", "image", OnlineStatus(false, "10 марта 2021", "10:19"), {"Беседа"}, {Folder("Все", {"1111", "2222", "3333", "4444", "5555"}, 1), Folder("Непрочитанные", {"1111", "3333"}, 2), Folder("Учёба", {"5555"}, 3), Folder("Мяу", {"3333"}, 4)}),
        User("Таня Пушкина", "image", OnlineStatus(true, "14 мая 2021", "00:09"), {}, {Folder("Все", {"1111", "2222", "3333", "4444", "5555"}, 1), Folder("Непрочитанные", {"1111", "3333"}, 2), Folder("Учёба", {"5555"}, 3), Folder("Мяу", {"3333"}, 4)}),
      },
      [
  ...
  Chat("",
      {
        User("Иван Петров", "image", OnlineStatus(true, "14 мая 2021", "00:09"), {"Все мы"}, {Folder("Все", {"1111", "2222", "3333", "4444", "5555"}, 1), Folder("Непрочитанные", {"1111", "3333"}, 2), Folder("Учёба", {"5555"}, 3), Folder("Мяу", {"3333"}, 4)}),
        User("Lev Franc", "image", OnlineStatus(true, "10 марта 2021", "10:19"), {"Важная беседа"}, {Folder("Все", {"1111", "2222", "3333", "4444", "5555"}, 1), Folder("Непрочитанные", {"1111", "3333"}, 2), Folder("Учёба", {"5555"}, 3), Folder("Мяу", {"3333"}, 4)}),
      },
      [
  ...
  Chat("",
      {
        User("Иван Петров", "image", OnlineStatus(true, "14 мая 2021", "00:09"), {"Все мы"}, {Folder("Все", {"1111", "2222", "3333", "4444", "5555"}, 1), Folder("Непрочитанные", {"1111", "3333"}, 2), Folder("Учёба", {"5555"}, 3), Folder("Мяу", {"3333"}, 4)}),
        User("Фёдор Барбарин", "image", OnlineStatus(true, "12 мая 2021", "10:19"), {}, {Folder("Все", {"1111", "2222", "3333", "4444", "5555"}, 1), Folder("Непрочитанные", {"1111", "3333"}, 2), Folder("Учёба", {"5555"}, 3), Folder("Мяу", {"3333"}, 4)}),
      },
      [
...
User me =  User("Иван Петров", "image", OnlineStatus(true, "14 мая 2021", "00:09"), {"Все мы"}, {Folder("Все", {"1111", "2222", "3333", "4444", "5555"}, 1), Folder("Непрочитанные", {"1111", "3333"}, 2), Folder("Учёба", {"5555"}, 3), Folder("Мяу", {"3333"}, 4)});